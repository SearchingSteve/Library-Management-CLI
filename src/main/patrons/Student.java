...
public class Student extends Patron {
    private int id; // Initalize variable id to only represent id of Student (by breaking up classes
    ...
    public Student(String name, String address, String phoneNumber, int id) {
        super(name, address, phoneNumber); // Call the constructor of the superclass Student to initialize the Student
                                           // fields
